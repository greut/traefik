...
type Provider struct {
	...
	WaitTime          ptypes.Duration `description:"Time limit for how long a Watch will block." json:"waitTime,omitempty" toml:"waitTime,omitempty" yaml:"waitTime,omitempty" export:"true"`
	...
	StrictChecks      bool            `description:"Consul nodes with checks status 'passing' will be kept, otherwise 'passing' or 'warning' are considered" json:"strictChecks,omitempty" toml:"strictChecks,omitempty" yaml:"strictChecks,omitempty" export:"true"`
